            ...
            if(data.outcome >= rangeWin){ // loss
                ...
                if(g_stopAt > g_currentAt){
                    ...
                    if(!cashedOut && betting){
                        if(g_currentAt <= 1.0015){
                         
                           console.log("Not cashed out, doing next bet");
                           placeBet( parseFloat(g_stopAt), parseFloat(g_bet), parseFloat(g_currentAt+0.0003), parseFloat( ( g_stake * g_currentAt ) ) );
                           return;
                        }else{
                           console.log("Not cashed out, doing next bet");
